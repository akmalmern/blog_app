...
>>>>>>> fc57a5d0facf280d12c6c5d7d074f3e873e5e572
  ...
  const MyPosts = async () => {
    try {
      const { data } = await axios.get("http://localhost:5000/my-posts", {
        withCredentials: true,
      });
      if (data.success === true) {
...
<input  className=" p-2 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file"  onChange={(e) => {
                           setImage(e.target.files[0])
                         }} />
    ...
    
{
    myposts.map((post,index)=>(
      <div className="rounded overflow-hidden shadow-lg flex flex-col" key={index+1}>
      ...
      <div className="px-6 py-4 mb-auto">
          <a href="#"
              className="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">{post.title}</a>
  ...
  <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" fill="white" stroke="red" strokeWidth="2"/>
              ...
              <span className="ml-1" style={{fontSize:"16px"}}>{post.likes.length}</span>
          </span>
...
>>>>>>> fc57a5d0facf280d12c6c5d7d074f3e873e5e572
      ...
      <div className="p-4 sm:ml-64">
        <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
          ...
          <div className="div">
            <h1 className="h1">Mening bloglarim</h1>
          </div>
            ...
            {myposts.map((post, index) => (
              ...
              >
                <div className="relative">
                  ...
                  <Link onClick={() => DeletePost(post._id)}>
                    <div className="text-xs absolute top-0 right-0 bg-red-600 px-4 py-2 text-white mt-3 mr-3 hover:bg-white hover:text-indigo-600 transition duration-500 ease-in-out">
                      Delete Post
                    </div>
                  </Link>
                </div>
